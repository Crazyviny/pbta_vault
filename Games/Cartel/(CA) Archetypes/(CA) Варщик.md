#CA #Archetypes #Technic #Lab #Proprietor
...
### Связи
- \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ – это *familia*. Близкий член семьи. Он не знает, чем ты занимаешься *para el cartel,* и ты не уверен, что сможешь долго хранить свои секреты.

- \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ втянул тебя в этот бизнес, чтобы помочь справиться с финансовыми проблемами, но не рассказал вам всей истории. Теперь вы влипли оба.

- Вы с \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ отлично понимаете друг друга. Сейчас вы друг другу нужны, но вы оба знаете, что нынешняя ситуация продлится не долго.

### Ходы
**Кроме отмеченного хода выбери еще два:**
#### Варка (Cocinar)
Если ты запасся всем необходимым и начинаешь варить, то в начале сессии будь Отважным. На 10+ ты варишь столько, сколько должен, и остается небольшой излишек для себя. На 7-9 ты варишь столько, сколько был должен, но твоя работа в лаборатории вызывает подозрения у кого-то из близких. В случае провала что-то пошло не так: по тебе бьет одна из проблем твоей лаборатории *con todo*.

#### Это наука, придурок! (Ciencia, cabrón)
...
#### Крикун (Chillón)
Когда ты **отмазываешься** резким эмоциональным всплеском, Отважным, а не Обаятельным.

#### Первоклассный товар (De Calidad)
Когда ты **предлагаешь сделку**, которая зависит от качества твоего товара или твоих особых навыков, Отважным, а не Обаятельным.
...
- Твоя лаборатория — это фургон с едой или дом на колесах. Замени стационарная на мобильная.
...
- В лаборатории есть оборудование для утилизации опасных химикатов. Убери нестабильная.
- У тебя есть помощник, который заранее готовит все компоненты для варки. Добавь +1 к проверкам Варки. Добавь зарплату.

Выбери 2 проблемы:
- Иногда твоя лаборатория недоступна. Добавь неудобная.
- В процессе работы выделяется побочный продукт или запах, который легко обнаружить и сообщить куда следует. Добавьте заметная.
- Лаборатория плохо защищена от злоумышленников и воров. Добавьте незащищенная.
- Лаборатория использует редкие химические вещества. Добавьте нехватка реагентов.

## Тайны
У тебя были тяжелые времена и теперь ты должен скрывать свою работу от самых близких. Выбери 3.
- Жена, муж  или подруга задает слишком много вопросов.
- Ребенок, который думает, что ты безупречен.
- Пожилая мать или дядя, который финансово от тебя зависит.
- Родственница, которая работает в федеральных правоохранительных органах.
